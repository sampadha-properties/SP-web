...
insert into public.properties (property_code, name, keyword, location, owner_name, contact_number, property_type, dimension, total_area, area_unit, price, price_unit)
values
  ('SP040', 'Existing commercial site', 'commercial', 'Hassan', 'Ramesh', '9876543210', 'Commercial', '30 x 40', 1200, 'sqft', 3500, 'sqft')
